...
{if isset($_smarty_debug_output) and $_smarty_debug_output eq "html"}
	...
	<tr bgcolor=#cccccc><th colspan=2><font color=#ff0000>In</font>Spire CMS Debug Console</th></tr>
...
<SCRIPT language=javascript>
	...
	_smarty_console.document.write("<HTML><TITLE>InSpire CMS Debug Console_"+self.name+"</TITLE><BODY bgcolor=#ffffff>");
	_smarty_console.document.write("<table border=0 width=100%>");
	_smarty_console.document.write("<tr bgcolor=#cccccc><th colspan=2><font color=#ff0000>In</font>Spire CMS Debug Console</th></tr>");
