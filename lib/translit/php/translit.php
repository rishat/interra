...
class Translit{
  ...
  //URL transliterating
  function UrlTranslit($string, $allow_slashes = TR_NO_SLASHES, $allow_dots = false)
  {
   $slash = "";
   $dots = "\.";
   $reverse = "";
   ...
   /* From InTerra V1.1 ==== увы, почему-то на мастерхосте Ч и М не "цеплялись", пришлось так */
   ...
   //transliterating
   $string = strtr($string, $bigToSmall );	// from InTerra V1.1
